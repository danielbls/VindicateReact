    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deed", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Deed_Milestone_MilestoneId",
                        column: x => x.MilestoneId,
                        principalTable: "Milestone",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deed_Priority_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "Priority",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deed_Status_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Status",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deed_MilestoneId",
                table: "Deed",
                column: "MilestoneId");

            migrationBuilder.CreateIndex(
                name: "IX_Deed_PriorityId",
                table: "Deed",
                column: "PriorityId");

            migrationBuilder.CreateIndex(
                name: "IX_Deed_StatusId",
                table: "Deed",
                column: "StatusId");
